...
var addTwoNumbers = function (l1, l2) {
    ...
    // 2）确定递归的出口条件及对应的值
    // 3）递归处理的函数体
    const dfs = (l1: ListNode, l2: ListNode, carry: number) => {
        ...
        const val_1: number = l1 ? l1.val : 0,
            val_2: number = l2 ? l2.val : 0,
            next_1: ListNode = l1 ? l1.next : null,
            next_2: ListNode = l2 ? l2.next : null,
            sum: number = (val_1 + val_2 + carry);
